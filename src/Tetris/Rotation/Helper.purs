...
rotationCoords (Block a b c d) =
  { l: {one: {x: b.x, y: b.y}, two: {x: c.x, y: c.y}, three: {x: c.x - blockWidth, y: b.y - blockHeight}, four: {x: b.x, y: c.y}}
  , z: {one: {x: b.x, y: b.y}, two: {x: d.x, y: c.y - (blockHeight * 2.0)}, three: {x: c.x, y: b.y}, four: {x: b.x, y: c.y - (blockHeight * 2.0)}}
  , t: {one: {x: b.x, y: b.y}, two: {x: b.x, y: b.y}, three: {x: b.x, y: b.y}, four: {x: b.x, y: b.y}}
  , s: {one: {x: c.x, y: c.y}, two: {x: d.x, y: c.y - (blockHeight)}, three: {x: b.x, y: c.y}, four: {x: b.x, y: c.y - (blockHeight)}}
  , mirrl: {one: {x: b.x, y: b.y}, two: {x: c.x, y: c.y}, three: {x: c.x - blockWidth, y: b.y - blockHeight}, four: {x: b.x, y: c.y}}
